...
export const BLOCK_CATALOG: BlockMeta[] = [
  // Heroes
  { variant: "HeroSplitPremium", category: "hero", sectors: ["saas", "ecommerce", "agency", "generic", "health"], prefer: ["ecommerce", "generic"], moods: ["minimal", "bold"], motion: 2, license: "ReFrame original (inspired by Linear/Stripe/Vercel)", when: "Split: copy left, a floating product-preview card (browser chrome + image, glow, mouse-follow tilt) right. The modern premium default." },
  { variant: "HeroBento", category: "hero", sectors: ["saas", "agency", "generic"], prefer: ["saas"], moods: ["bold", "minimal"], motion: 2, license: "ReFrame original (inspired by Framer bento templates)", when: "Headline + a bento fusing the product preview with real metrics (when genuine) or key services. SaaS/proof-led brands." },
  { variant: "HeroAurora", category: "hero", sectors: ["saas", "agency", "ecommerce", "generic", "health"], prefer: ["health"], moods: ["bold", "minimal"], motion: 3, license: "ReFrame original (effects inspired by Linear/Framer ambient detailing)", when: "Cinematic ambient hero: drifting brand aurora, overhead spotlight, faint meteors, blur-fade copy, beam-lit product preview. Atmospheric tech/wellness brands." },
  ...
  { variant: "HeroImageFull", category: "hero", sectors: ["restaurant", "realestate", "health", "agency", "ecommerce"], prefer: ["restaurant"], moods: ["warm", "elegant", "bold"], motion: 2, license: "ReFrame original", when: "Full-bleed immersive image hero with an editorial scrim; image-led sectors (hospitality, property, retail)." },
  { variant: "HeroMonumental", category: "hero", sectors: ["realestate", "agency", "restaurant", "ecommerce"], prefer: ["realestate"], moods: ["bold"], motion: 2, license: "ReFrame original (inspired by ARCFORM/Archinest Framer templates)", when: "Full-bleed photo + colossal brand wordmark across the bottom; confident, bold, image-led brands." },
  { variant: "HeroAgencia", category: "hero", sectors: ["agency", "saas", "ecommerce", "generic"], prefer: ["agency"], moods: ["bold"], motion: 3, license: "ReFrame original (inspired by Agencia/Framer agency templates)", when: "Near-black canvas, colossal condensed wordmark, ember accent, two-tone tagline; bold modern studios/agencies." },
