...
export const BLOCK_CATALOG: BlockMeta[] = [
  ...
  { variant: "HeroCollage", category: "hero", sectors: ["restaurant", "hotel", "realestate", "health", "fashion", "architect"], prefer: ["restaurant", "hotel"], moods: ["warm", "elegant"], motion: 2, license: "ReFrame original (inspired by editorial collage refs + ARCHFORM reveal)", when: "Editorial SPLIT hero: serif masked-reveal headline beside a two-image collage. Co-signature with HeroImageFull for hospitality, so two same-sector brands get different first impressions." },
  { variant: "HeroMonumental", category: "hero", sectors: ["realestate", "agency", "restaurant", "ecommerce", "architect", "construction"], prefer: ["architect", "realestate"], moods: ["bold"], motion: 2, license: "ReFrame original (inspired by ARCFORM/Archinest Framer templates)", when: "Full-bleed photo + colossal brand wordmark across the bottom; confident, bold, image-led brands. Co-signature with HeroArchform for architect/realestate." },
  ...
  { variant: "HeroArchform", category: "hero", sectors: ["realestate", "agency", "restaurant", "ecommerce", "generic", "health", "hotel", "architect", "construction", "automotive"], prefer: ["realestate", "architect"], moods: ["bold"], motion: 2, license: "ReFrame original (inspired by ARCHFORM/Framer premium)", when: "Full-bleed photo with a colossal UPPERCASE display line bottom-left, brand + sector meta row, pill CTAs and a scroll cue; bold, image-led, architectural brands. Co-signature with HeroMonumental for architect/realestate." },
  ...
  { variant: "ServicesAtelier", category: "services", sectors: "all", moods: ["elegant", "warm", "minimal"], motion: 1, license: "ReFrame original (Archform index + 21st interactive-list archetype, reinterpreted)", when: "Interactive editorial index: a sticky image panel beside numbered serif rows the visitor plays (hover lights a row, crossfades the panel). Scores level with ServicesList so same-sector brands split between the two architectures." },
  ...
  { variant: "AboutAtelier", category: "about", sectors: ["restaurant", "realestate", "health", "ecommerce", "hotel", "architect", "lawyer", "fashion", "medical", "finance"], moods: ["elegant", "warm"], motion: 1, license: "ReFrame original (Archform Studio grid, reinterpreted)", when: "Studio-magazine about: mono-caps meta row, monumental serif display with an italic closing word, image LEFT beside a two-column narrative + inline stats. Ties with StatementEditorial so same-sector brands split between the two architectures (agency untouched)." },
