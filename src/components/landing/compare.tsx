...
function AfterSite() {
  ...
  return (
    <div className="relative h-full w-full overflow-hidden bg-white text-zinc-900">
      <div className="absolute right-0 top-0 h-full w-1/2 bg-gradient-to-bl from-zinc-100 via-white to-white" />
      <div className="absolute -right-24 -top-24 h-80 w-80 rounded-full bg-zinc-200/50 blur-3xl" />
